        ...
        <FightMetricSection
            ...
            renderTitleExtra={() => (
                <div className="relative" ref={dropdownRef}>
                    ...
                    {boonDropdownOpen && (
                        <div className="app-dropdown absolute top-full left-0 mt-2 z-50 w-96 rounded-lg border border-white/10 bg-[rgba(15,18,25,0.75)] backdrop-blur-xl shadow-xl p-3 space-y-2">
                            <PillToggleGroup
                                value={timelineScope}
