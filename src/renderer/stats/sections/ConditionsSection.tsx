                            ...
                            <>
                                {(() => {
                                    ...
                                    return rows.map((entry: any, idx: number) => {
                                        ...
                                        return (
                                            <div key={`${entry.account}-${idx}`} className={`grid ${conditionGridClass} px-4 py-2 text-xs text-[color:var(--text-primary)] border-b border-[color:var(--border-subtle)] hover:bg-[var(--bg-hover)]`}>
